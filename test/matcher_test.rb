...
class MatcherTest < MiniTest::Test
  ...
  def setup
    ...
    @ngram = 3
    @matcher = Matcher.new first_text: @first_text, second_text: @second_text, ngram: @ngram
  end
  ...
  def test_first_text_hash
    assert_kind_of Array, @matcher.first_text_hash
  end

  def test_second_text_hash
    assert_kind_of Array, @matcher.second_text_hash
  end
end
